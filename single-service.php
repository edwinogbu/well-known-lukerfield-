		...
		<main class="page-content">
			...
			<section id="pg-service-area" class="cr-section bg--white pg-service-area section-padding--xlg">
						...
						<div class="row align-items-xl-center align-items-start">
							<div class="col-lg-6">
								<div class="pg-service__thumb wow fadeInLeft">
									<img src="images/service/pg-service-thumb.jpg" alt="service page thumb">
								</div>
							</div>
							<div class="col-lg-6">
								<div class="pg-service__content">
									<h2>INSURANCE <span class="color--theme">CONSULTING</span></h2>
									<p>perspiciatis unde omnis iste natus error sit voluptatem accusantium ue laudantium, totam rem aperiam, eaque
										ipsa
										quae </p>
									<p>perspiciatis unde omnis ist natus error sit voluptatem accusantium ue tium totam rem aperiam eaque numquam
										eius
										modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem</p>
									<p>perspiciatis unde omnis ist natus error sit voluptatem accusantium que tium totam rem aperiam eaque numquam
										eius
					...
					<div class="container">
						<div class="pg-service__blocks">
							...
							<div class="pg-service__block">
								...
								<p>perspiciatis unde omnis ist natus error sit voluptatem accusantium ue totam rem aperiam eaque numquam eius
									modi
				...
				<div class="pg-service__pagination">
					<a href="single-service.html" class="service-pagination prev">Prev</a>
					<a href="single-service.html" class="service-pagination next">Next</a>
				</div>
				<!--// Service Page Pagination -->
